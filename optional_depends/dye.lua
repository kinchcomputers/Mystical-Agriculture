mystical_agriculture2022.register_normal_ore_crop("dye","group:dye","Dye",0,0)

local dye_recipies = function(dye) 
minetest.register_craft({
		type = "shapeless",
		output = dye.." 2",
		recipe = {"mystical_agriculture2022:dye_essence",dye},
})
end
...
minetest.register_craft({
        output = "dye:white 2",
        recipe = {
            {"mystical_agriculture2022:dye_essence","mystical_agriculture2022:dye_essence",""},
            {"","",""},
            {"","",""},
        }
    })
minetest.register_craft({
        output = "dye:grey 2",
        recipe = {
            {"mystical_agriculture2022:dye_essence","",""},
            {"mystical_agriculture2022:dye_essence","",""},
            {"","",""},
        }
    })
